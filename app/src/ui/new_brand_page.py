...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(450, 560)
        Form.setMinimumSize(QtCore.QSize(450, 560))
        Form.setMaximumSize(QtCore.QSize(450, 560))
        Form.setStyleSheet("*{\n"
"font: 10pt \"Noto Sans\";\n"
"color: #1E1E1E;\n"
...
"color: #333333;")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.brand_lineEdit.sizePolicy().hasHeightForWidth())
        self.brand_lineEdit.setSizePolicy(sizePolicy)
        ...
        self.horizontalLayout_2.addWidget(self.brand_lineEdit, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
...
"border-radius: 5px;")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Add New Brand"))
        self.label.setText(_translate("Form", "Add New Brand:"))
        self.label_2.setText(_translate("Form", "Brand Name:"))
